  ...
  useEffect(() => {
    ...
    statsApi.circuitHistory(circuit.circuitId)
      .then(res => {
        ...
        setData({ dna: computeDNA(races), winners: topWinners(races), total: races.length })
      })
      .catch(() => {})
            ...
            <div style={{ flex: '0 0 260px' }}>
              <ResponsiveContainer width="100%" height={220}>
                <RadarChart data={data.dna} margin={{ top: 10, right: 30, bottom: 10, left: 30 }}>
                  ...
                  <PolarAngleAxis
                    dataKey="metric"
                    tick={{ fill: 'rgba(255,255,255,0.55)', fontSize: 11, fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700 }}
                  />
                  <PolarRadiusAxis domain={[0, 100]} tick={false} axisLine={false} />
                  <Radar dataKey="value" stroke="#e10600" fill="#e10600" fillOpacity={0.18} strokeWidth={1.5} />
                </RadarChart>
              </ResponsiveContainer>
                  ...
                  return (
                    <div key={d.metric} style={{
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: '0.68rem', fontWeight: 700, color: 'var(--text-primary)', textTransform: 'uppercase', letterSpacing: '0.06em', lineHeight: 1.2 }}>
                          {d.metric}
                        </div>
